...
/**
 * write_history - This will append to an *existing file or creates a new file
 * @info: this is the parameter structure
 ...
 * @info: this is a Structure containing *potential arguments. it is Used to maintain
...
/**
 * renumber_history-afterchanges,renumberthe history linked list
 * @info: this is a Structure containing *potential arguments. it is Used to maintain
 * constant function prototype.
